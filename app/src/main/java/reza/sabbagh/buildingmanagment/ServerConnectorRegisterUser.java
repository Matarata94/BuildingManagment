...
public class ServerConnectorRegisterUser extends AsyncTask{
	...
	public ServerConnectorRegisterUser(String link, String requesttype, String registeras, String username, String password, String fname, String lname, String phonenumber,
	...
	protected String doInBackground(Object... params) {
		try{
			...
			RegisterUserActivity.resRegisterUser = sb.toString();
		}catch(Exception e){
